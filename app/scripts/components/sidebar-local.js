...
const sidebarMenuData = [
  ...
  { label: "User Data", href: "/users" },
  { label: "Donor Data", href: "/donors" },
  { label: "Programme Data", href: "/programmes" },
  ...
  function setActiveLink() {
    ...
    document.querySelectorAll(".sidebar-menu a").forEach((link) => {
      ...
      const isDashboardRoute =
        normalizedCurrentPath === "/dashboard" || normalizedCurrentPath === "/";
      const isDashboardLink = normalizedLinkHref === "/dashboard";
